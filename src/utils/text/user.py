...
# ======================================================== Subscribe
SUBSCRIBE_SUCCESS = '<b>🎉 Спасибо за вашу подписку 🎉</b>'
SUBSCRIBE_DOESNT_EXIST = '<b>❗️ Вы не подписались на наш канал ❗️</b>'
NOT_BALANCE_MONEY = '<b>У вас не достаточно средств на балансе</b>'
